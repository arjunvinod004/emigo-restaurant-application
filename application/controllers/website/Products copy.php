    ...
    ?>
            ...
            <div class="product" data-id="<?php echo $product['product_id']; ?>"
                ...
                <button data-quantity="<?php echo $quantity; ?>"
                    ...
                    data-bs-target="#productCustomize" <?php echo $disabled; ?>><?php echo $btntext; ?></button>
            </div>
            <?php }else{
...
<div class="bg-white p-3 mb-3 rounded product">
    <h6 class="mb-1">Choose your variantwww</h6>
    <div class="mb-3">
   ...
   ?>
        ...
        <button class=" btn-sm decrement">-</button>
                                <input type="number" class="form-control1 d-inline-block variant-qty"
                                    value="<?php echo $quantity; ?>" min="0">
                                <button data-prodId="<?php echo $product; ?>" class="btn-sm increment">+</button>
                            </div>
                        </div>
                    </div>
...
<?php
    ...
    public function checkStockAvailability()
    {
        ...
        $stock = $this->Ordermodel->getCurrentStock($product_id, date('Y-m-d'), $this->session->userdata('store_id'));
        if ($stock > $quantity) {
            echo 'success';
        } else {
            echo $this->Productmodel->getProductName($product_id) . ' is out of stock.';
        }
    }
