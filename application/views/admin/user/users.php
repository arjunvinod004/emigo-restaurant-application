                                    ...
                                    <td class="pb-0 pt-0 d-flex">
                                         <!-- <form class="m-0" action="<?php echo base_url();?>admin/user/edit" 
                                            ...
                                            <button class="btn tblEditBtn edit_user pl-0 pr-0" type="submit"
                                                data-bs-toggle="modal" data-id="<?php echo $val['userid']; ?>" data-bs-target="#edit-user"
                                                data-bs-original-title="Edit User"><i class="fa fa-edit"></i></button>
                                        <!-- </form> -->
 ...
 <div class="modal fade" id="add-user" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <form class="row mt-0 mb-0" id="add-new-user" method="post" enctype="multipart/form-data">
                ...
                <div class="modal-content">
                    ...
                    <form class="row mt-0 mb-0" id="edit-new-user" method="post" enctype="multipart/form-data">
                       <input type="hidden" id="hidden_user_id" >
                        ...
                        <div class="col-md-12">
                            <div class="justify-content-center" style="float: right;">
                                <button class="btn btn-primary w-md" type="button" id="save_user">Update</button>
                            </div>
                        </div>
                    </form>
                </div>
    ...
    <div class="modal-dialog modal-sm">
        <div class="modal-content">
            ...
            <div class="modal-footer"><button class="btn btn-primary" type="button" data-bs-dismiss="modal">No</button>
                <button class="btn btn-secondary" id="yes_del_user_user" type="button" data-bs-dismiss="modal">Yes</button>
            </div>
