...
<div class="errormsg mt-2" role="alert"><?php echo form_error('package_name'); ?></div>
      <?php } ?>
        ...
        <?php
            ...
            <tr class="table-row">
              ...
              <input type="hidden" class="form-control" id="current_table_name_hidden" name="current_table_name_hidden" value="<?php echo $val['table_name'];?>">
              </td>
                <td><input type="checkbox" class="form-check-input customCheck1"  value="<?php  echo $val['is_whatsapp'];?>" data-storeid="<?php echo $storeDet[0]['store_id']; ?>" data-tablename="<?php echo $val['table_id'] ;?>" <?php echo ($val['is_whatsapp'] == 1) ? 'checked' : ''; ?>   data-attr="table"></td>
                <td>
                  <select name=""  class="form-select w-50 whatsappSelect">
                    ...
                    <option value="<?php echo $whatsapp['whatsapp_no']; ?>" <?php echo ($val['whatsapp_no'] == $whatsapp['whatsapp_no']) ? 'selected' : ''; ?>><?php echo $whatsapp['whatsapp_no']; ?></option>
    ...
    foreach ($storeDet as $store) { ?>
        ...
        <tr class="table-row">
            ...
            <td>
                <input type="checkbox" class="form-check-input customCheck1"
                       ...
                       data-storeid="<?php echo $store['store_id']; ?>"
                       data-tablename="Delivery"
                       data-attr="delivery"
            ...
            <td>
                ...
                <option value="0">Select Whatsapp No</option>
                 ...
                 <option value="<?php echo $whatsapp['whatsapp_no']; ?>" <?php echo ($store['delivery_whatsapp_no'] == $whatsapp['whatsapp_no']) ? 'selected' : ''; ?>>  <?php echo $whatsapp['whatsapp_no']; ?></option>
            ...
            <td>
                ...
                <a href="<?php echo base_url(); ?>admin/qrcodes/generateDeliveryQrCode1/<?php echo $store['store_id']; ?>" class="btn tblEditBtn pl-0 pr-0"><i class="fa fa-download"></i></a>
            </td>
        </tr>
        ...
        <tr class="table-row">
                ...
                <select class="form-select w-50 whatsappSelect">
                  <option value="0">Select Whatsapp No</option>
                   <?php foreach($whatsappNo as $whatsapp){?>
                    ...
                    <option value="<?php echo $whatsapp['whatsapp_no']; ?>" <?php echo ($store['pickup_whatsapp_no'] == $whatsapp['whatsapp_no']) ? 'selected' : ''; ?>><?php echo $whatsapp['whatsapp_no']; ?></option>
            ...
            <td>
                <a class="btn tblDelBtn pl-0 pr-0 del_table" type="button"><i class="fa fa-trash"></i></a>
                <a href="<?php echo base_url(); ?>admin/qrcodes/generatePickupQRCode1/<?php echo $store['store_id']; ?>" class="btn tblEditBtn pl-0 pr-0"><i class="fa fa-download"></i></a>
            </td>
        </tr>
