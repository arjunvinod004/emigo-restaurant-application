                            ...
                            <div class="row">
                                ...
                                ?>
                                                        <option value="<?=$country['country_id'];?>"
                                                            <?php echo set_select('country', $country['country_id'])?>>
                                                            <?=$country['name'];?></option>
                                                        <?php
                                }
                                ?>
                                            ...
                                            <div class="form-group textbox row mb-2 d-none">
                                                ...
                                                <div class="col-sm-10  mb-2">
                                                    <input name="bill_no" class="form-control"
                                                        value="<?php echo set_value('bill_no'); ?>" id="inputbillno"
                                                        placeholder="">
      ...
      <?php } ?> -->
                                            ...
                                            <div class="form-group row mb-2">
                                                ...
                                                <div class="col-sm-10 mb-2">
                                                    <input name="disp_name" class="form-control"
                                                        value="<?php echo set_value('disp_name'); ?>" id="inputPassword"
                                                        placeholder="">
                                                    <?php if(form_error('disp_name')){ ?>
                                                    <div class="errormsg mt-2" role="alert">
                                            ...
                                            <div class="form-group row mb-2">
                                                ...
                                                <div class="col-sm-4 mb-2">
                                                    <textarea name="address" class="form-control"
                                                        ...
                                                        rows=""><?php echo set_value('address'); ?></textarea>
                                            ...
                                            <div class="form-group row mb-2">
                                                ...
                                                <div class="col-sm-10 mb-2">
                                                    <textarea name="store_desc" class="form-control"
                                                        id="exampleFormControlTextarea4"
                                                        rows="3"><?php echo set_value('store_desc'); ?></textarea>
                                                    <?php if(form_error('store_desc')){ ?>
                                                    <div class="errormsg mt-2" role="alert">
                                                        <?php echo form_error('store_desc'); ?></div>
                                                    <?php } ?>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row mb-2">
                                                ...
                                                <div class="col-sm-2 mb-2">
                                                    <div id="datepicker" class="input-group date"
                                                        ...
                                                        <input name="contract_start_date" class="form-control"
                                                            value="<?php echo set_value('contract_start_date'); ?>"
                                                            type="text">
                                                ...
                                                <div class="col-sm-2">
                                                    <input type="text" class="form-control" id="datepicker2"
                                                        ...
                                                        value="<?php echo set_value('next_followup_date'); ?>"
                                            ...
                                            <div class="form-group row mb-2">
                                                ...
                                                <div class="col-sm-10 mb-2">
                                                    <input name="followup_remarks" class="form-control"
                                                        value="<?php echo set_value('followup_remarks'); ?>"
                                            ...
                                            <div class="form-group row mb-2">
                                                ...
                                                <div class="col-sm-4 mb-2">
                                                    <input class="form-control" type="time"
                                                        value="<?php echo set_value('store_opening_time'); ?>"
                                                ...
                                                <div class="col-sm-4">
                                                    <input class="form-control" type="time"
                                                        value="<?php echo set_value('store_closing_time'); ?>"
                                ...
                                ?>
                                                        <option value="<?=$package['package_id'];?>"
                                                            <?php echo set_select('no_of_tables', $package['package_id'])?>>
                                                            <?=$package['name'];?></option>
                                                        <?php
                                }
                                ?>
                                                    ...
                                                    <div class="errormsg mt-2" role="alert">
                                                        <?php echo form_error('no_of_tables'); ?></div>
                                                    <?php } ?>
                                                </div>
                                                <label class="col-sm-2 col-form-label">Trade License</label>
                                                <div class="col-sm-4">
                                                    <input class="form-control"
                                                        value="<?php echo set_value('trade_license'); ?>" type="text"
                                                        name="trade_license">
                                                    <?php if(form_error('trade_license')){ ?>
                                                    <div class="errormsg mt-2" role="alert">
                                                        <?php echo form_error('trade_license'); ?></div>
                                                    <?php } ?>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row mb-2">
                                                ...
                                                <div class="col-sm-10 mb-2">
                                                    <input name="location" class="form-control"
                                                        value="<?php echo set_value('location'); ?>" id="inputPassword"
                                                        placeholder="">
                                            ...
                                            <div class="form-group row mb-2">
                                                ...
                                                <div class="col-sm-10">
                                                    <select class="form-select" name="language">
                                                        ...
                                                        <option value="ma" <?= set_select('language', 'ma') ?>>Malayalam
                                                        </option>
                                                        <option value="hi" <?= set_select('language', 'hi') ?>>Hindi
                                                        </option>
                                                        <option value="en" <?= set_select('language', 'en') ?>>English
                                                        </option>
                                                        <option value="ar" <?= set_select('language', 'ar') ?>>Arabic
                                                        </option>
                                                    </select>
                                            ...
                                            <div class="row mb-4">
                                                ...
                                                <div class="col-sm-2 d-flex">
                                                    ...
                                                    <input type="hidden" name="checkbox_pickup_or_take_away" value="0"
                                                        id="pickup_hidden">
                                                </div>

                                                <div class="col-sm-2">
                                                    <input type="text" placeholder="Country code (91)"
                                                        value="<?php echo set_value('pickup_country_code'); ?>"
                                                ...
                                                <div class="col-sm-4 d-flex">
                                                    <input type="text" placeholder="Enter Pickup Number"
                                                        value="<?php echo set_value('txt_pickup_or_take_away'); ?>"
                                                        class="form-control" name="txt_pickup_or_take_away"
                                                        id="txt_pickup_or_take_away">
                                                </div>
                                                <div class="col-sm-2 d-flex">
                                                    <a class="btn btn-primary" id="send_pickup_test_message">Send
                                                        Test Message</a>
                                                </div>
                                            </div>
                                            <div class="row mb-4">
                                                ...
                                                <div class="col-sm-2 d-flex">
                                                    <input class="form-check-input" type="checkbox" value=""
                                                        name="checkbox_dining" id="checkbox_dining">
                                                    <input type="hidden" name="checkbox_dining" value="0"
                                                        id="dining_hidden">
                                                </div>

                                                <div class="col-sm-2">
                                                    <input type="text" placeholder="Country code (91)"
                                                        value="<?php echo set_value('dining_country_code'); ?>"
                                                ...
                                                <div class="col-sm-4 d-flex">
                                                    <input type="text" placeholder="Enter Dining Number"
                                                        class="form-control"
                                                        value="<?php echo set_value('txt_dining'); ?>" name="txt_dining"
                                                        id="txt_dining">
                                                </div>
                                                <div class="col-sm-2 d-flex">
                                                    <a class="btn btn-primary" id="send_dining_test_message">Send
                                                        Test Message</a>
                                                </div>
                                            </div>
                                            <div class="row mb-4">
                                                ...
                                                <div class="col-sm-2">
                                                    <input type="text" placeholder="Country code (91)"
                                                        value="<?php echo set_value('delivery_country_code'); ?>"
                                                ...
                                                <div class="col-sm-4 d-flex">
                                                    <input type="text" placeholder="Enter Delivery Number"
                                                        class="form-control"
                                                        value="<?php echo set_value('txt_delivery'); ?>"
                                                        name="txt_delivery" id="txt_delivery">
                                                </div>
                                                <div class="col-sm-2 d-flex">
                                                    <a class="btn btn-primary" id="send_delivery_test_message">Send
                                                        Test Message</a>
                                                </div>
                                            </div>
                                            ...
                                            <!-- row end -->
                                            <button class="btn btn-primary pull-right mt-4" type="submit"
                                        ...
                                        <div class="col-xl-3 col-md-6">
                                            <form class="m-0"
                                                ...
                                                <div class="card-body bg-b-success">
                                                    <button class="bg-b-success" style="border: none;" type="submit">
                                                        <div class="row align-items-center">
                                                            <div class="col-8">
                                                                <span class="text-white text-truncate"
                                                                    style="font-size: 19px;">Download Pickup QR
                                                                    Code</span>
                                                                <span class="text-white text-truncate"
                                                ...
                                                <div class="card-body bg-b-success">
                                                    <button class="bg-b-success" style="border: none;" type="submit">
                                                        <div class="row align-items-center">
                                                            <div class="col-8">
                                                                <span class="text-white text-truncate"
                                                                    style="font-size: 19px;">Download Delivery QR
                                                                    Code</span>
                                                                <span class="text-white text-truncate"
                                            ...
                                            <a class="store_table btn tblLogBtn pl-0 pr-0" id=""
                                                ...
                                                <div class="card-body bg-b-success">
                                                    <div class="row align-items-center">
                                                        <div class="col-8">
                                                            <span class="text-white text-truncate"
                                                                style="font-size: 19px;">Generate Table QR Codes</span>
                                                        </div>
                                                        <div class="col-4 icon">
                                                            <i class="fa fa-qrcode" style="font-size: 50px;"></i>
                                                        </div>
