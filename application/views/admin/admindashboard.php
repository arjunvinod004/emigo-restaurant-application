    ...
    <div class="application-content__container container">
        <div class="application-main-menus">
            ...
            <div class="application-main-menus__content">
                <a href="<?php echo base_url('admin/product'); ?>" class="application-main-menus__items">
                    <span class="application-main-menus__items-icon-wrapper">
                        <img src="<?php echo base_url();?>assets/admin/images/main-menu-dishes-icon.svg"
                ...
                <a href="<?php echo base_url('admin/product/index'); ?>" class="application-main-menus__items">
                    <span class="application-main-menus__items-icon-wrapper">
