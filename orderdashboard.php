        ...
        <div class="tabs orderdashboard-tab">
            <div class="tabs__row">
                <ul class="tabs__nav">
                    ...
                    <li class="active"><a href="#tabs1">Tables <span id="tabs__nav_pending_table_count" class="d-none"></span> </a>
                    </li>
                    <li class=""><a href="#tabs2">Pickup Orders <span id="tabs__nav_pending_pickup_count" class="d-none"></span> </a>
                    </li>
                    <li class=""><a href="#tabs3">Delivery Orders<span id="tabs__nav_pending_delivery_count" class="d-none"></span>
                        </a></li>
                    <li class=""><a href="#tabs4">Ready Orders<span id="tabs__nav_approved_ready_count" class="d-none"></span>
                        </a></li>
                </ul>
                    ...
                    <div id="tabs4" class="tabs__pane">
                        <div class="order-table-list">
                            ...
                            <div class="order-table-list__item">
                                ...
                                <div class="mt-2">
                                    <button type="button" class="btn btn-ready w-100">Ready</button>
                                </div>
                            </div>
                            <?php } ?>
                        </div>
